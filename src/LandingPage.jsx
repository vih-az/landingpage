...
<section className=" mx-auto bg-[#0a3062] w-full h-[34rem] flex flex-col justify-center items-center bg-[url(https://i.postimg.cc/SQzzGS7n/Whats-App-Image-2025-08-04-at-17-18-47a.jpg)] text-white bg-no-repeat bg-center bg-cover">
